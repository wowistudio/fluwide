    ...
    <Container className="relative pb-24 pt-[96px] text-center lg:pt-32 h-[calc(100dvh)] flex items-center">
      <div className='w-full'>
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight sm:text-7xl pointer-events-none">
          Fluid{' '}
          {/* <span className="relative whitespace-nowrap text-accent text-blue-300/90">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute left-0 top-2/3 h-[0.58em] w-full fill-blue-300/50"
          ...
          <span className="relative whitespace-nowrap text-foreground/50">
            <span className="relative">fullstack</span>
          </span>
          <span className='block'>engineering</span>
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg">
          I am an allround developer with a focus on fluid collaboration, proactivity, and continuous learning.
        </p>
